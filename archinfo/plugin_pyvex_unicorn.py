...
class PyvexUnicornPlugin(ArchPlugin):
    ...
    def _fill_2(cls, arch, endness, instruction_endness):
        super()._fill_2(arch, endness, instruction_endness)
...
class PyvexUnicornAMD64(PyvexUnicornPlugin):
    @classmethod
    def _fill_2(cls, arch, endness, instruction_endness):
        super()._fill_2(arch, endness, instruction_endness)
        ...
        # Register blacklist
        reg_blacklist = ("fs", "gs")
        if arch.reg_blacklist is not None and arch.reg_blacklist_offsets is not None:
...
class PyvexUnicornX86(PyvexUnicornPlugin):
    @classmethod
    def _fill_2(cls, arch, endness, instruction_endness):
        super()._fill_2(arch, endness, instruction_endness)

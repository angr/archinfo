...
class ArchAMD64(Arch):
    ...
    register_list = [
        ...
        Register(name='cc_op', size=8, vex_offset=144, default_value=(0, False, None)),
        Register(name='cc_dep1', size=8, vex_offset=152),
        Register(name='cc_dep2', size=8, vex_offset=160),
        Register(name='cc_ndep', size=8, vex_offset=168),
        ...
        Register(name='gs', size=8, vex_offset=904, alias_names=('gs_const',)),
        Register(name='ip_at_syscall', size=8, vex_offset=912),
    ]

...
class ArchAMD64(Arch):
    ...
    register_list = [
        ...
        Register(name='cr1', size=8),
        Register(name='cr2', size=8),
        Register(name='cr3', size=8),
        Register(name='cr4', size=8),
        Register(name='cr5', size=8),
        Register(name='cr6', size=8),
        Register(name='cr7', size=8),
        Register(name='cr8', size=8),
        Register(name='cr9', size=8),
        Register(name='cr10', size=8),
        Register(name='cr11', size=8),
        Register(name='cr12', size=8),
        Register(name='cr13', size=8),
        Register(name='cr14', size=8),
        Register(name='cr15', size=8),
        ...
        Register(name='ymm15', size=32, subregisters=[('xmm15', 0, 16),
                                                      ...
                                                      ('xmm15hq', 8, 8)],
                 vector=True),
        Register(name='ymm16', size=32, subregisters=[('xmm16', 0, 16),
                                                      ('xmm16lq', 0, 8),
                                                      ('xmm16hq', 8, 8)],
                 vector=True),

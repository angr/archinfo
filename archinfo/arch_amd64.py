...
class ArchAMD64(Arch):
    ...
    register_list = [
        Register(name='rax', size=8, vex_offset=16, subregisters=[('eax', 0, 4),
                                                                  ('ax', 0, 2),
                                                                  ('al', 0, 1),
                                                                  ('ah', 1, 1)], 
                 general_purpose=True, linux_entry_value=0x1C),
        Register(name='rcx', size=8, vex_offset=24, subregisters=[('ecx', 0, 4),
                                                                  ('cx', 0, 2),
                                                                  ('cl', 0, 1),
                                                                  ('ch', 1, 1)], 
                 general_purpose=True, argument=True),
        Register(name='rdx', size=8, vex_offset=32, subregisters=[('edx', 0, 4),
                                                                  ('dx', 0, 2),
                                                                  ('dl', 0, 1),
                                                                  ('dh', 1, 1)], 
                 general_purpose=True, argument=True, linux_entry_value='ld_destructor'),
        Register(name='rbx', size=8, vex_offset=40, subregisters=[('ebx', 0, 4),
                                                                  ('bx', 0, 2),
                                                                  ('bl', 0, 1),
                                                                  ('bh', 1, 1)], 
                 general_purpose=True),
        Register(name='rsp', size=8, vex_offset=48, subregisters=[('esp', 0, 4)], alias_names=('sp',), 
                 general_purpose=True, default_value=(initial_sp, True, 'global')),
        Register(name='rbp', size=8, vex_offset=56, subregisters=[('ebp', 0, 4)], alias_names=('bp',), 
                 general_purpose=True),
        Register(name='rsi', size=8, vex_offset=64, subregisters=[('esi', 0, 4),
                                                                  ('si', 0, 2),
                                                                  ('sil', 0, 1),
                                                                  ('sih', 1, 1)], 
                 general_purpose=True, argument=True),
        Register(name='rdi', size=8, vex_offset=72, subregisters=[('edi', 0, 4),
                                                                  ('di', 0, 2),
                                                                  ('dil', 0, 1),
                                                                  ('dih', 1, 1)], 
                 general_purpose=True, argument=True),
        Register(name='r8', size=8, vex_offset=80, general_purpose=True, argument=True),
        Register(name='r9', size=8, vex_offset=88, general_purpose=True, argument=True),
        Register(name='r10', size=8, vex_offset=96, general_purpose=True, argument=True),
        Register(name='r11', size=8, vex_offset=104, general_purpose=True),
        Register(name='r12', size=8, vex_offset=112, general_purpose=True),
        Register(name='r13', size=8, vex_offset=120, general_purpose=True),
        Register(name='r14', size=8, vex_offset=128, general_purpose=True),
        Register(name='r15', size=8, vex_offset=136, general_purpose=True),
        Register(name='cc_op', size=8, vex_offset=144, default_value=(0, False, None), concrete=False),
        Register(name='cc_dep1', size=8, vex_offset=152, concrete=False),
        Register(name='cc_dep2', size=8, vex_offset=160, concrete=False),
        Register(name='cc_ndep', size=8, vex_offset=168, concrete=False),
        Register(name='d', size=8, vex_offset=176, alias_names=('dflag',),
                 default_value=(1, False, None), concrete=False),
        Register(name='rip', size=8, vex_offset=184, alias_names=('ip', 'pc'),
                 general_purpose=True),
        Register(name='ac', size=8, vex_offset=192, alias_names=('acflag',)),
        Register(name='id', size=8, vex_offset=200, alias_names=('idflag',)),
        Register(name='fs', size=8, vex_offset=208, alias_names=('fs_const',),
                 default_value=(0x9000000000000000, True, 'global'), concrete=False),
        Register(name='sseround', size=8, vex_offset=216, vector=True,
                 default_value=(0, False, None)), 
        Register(name='ymm0', size=32, vex_offset=224, subregisters=[('xmm0', 0, 16)], vector=True), 
        Register(name='ymm1', size=32, vex_offset=256, subregisters=[('xmm1', 0, 16)], vector=True), 
        Register(name='ymm2', size=32, vex_offset=288, subregisters=[('xmm2', 0, 16)], vector=True), 
        Register(name='ymm3', size=32, vex_offset=320, subregisters=[('xmm3', 0, 16)], vector=True), 
        Register(name='ymm4', size=32, vex_offset=352, subregisters=[('xmm4', 0, 16)], vector=True), 
        Register(name='ymm5', size=32, vex_offset=384, subregisters=[('xmm5', 0, 16)], vector=True), 
        Register(name='ymm6', size=32, vex_offset=416, subregisters=[('xmm6', 0, 16)], vector=True), 
        Register(name='ymm7', size=32, vex_offset=448, subregisters=[('xmm7', 0, 16)], vector=True), 
        Register(name='ymm8', size=32, vex_offset=480, subregisters=[('xmm8', 0, 16)], vector=True), 
        Register(name='ymm9', size=32, vex_offset=512, subregisters=[('xmm9', 0, 16)], vector=True), 
        Register(name='ymm10', size=32, vex_offset=544, subregisters=[('xmm10', 0, 16)], vector=True), 
        Register(name='ymm11', size=32, vex_offset=576, subregisters=[('xmm11', 0, 16)], vector=True), 
        Register(name='ymm12', size=32, vex_offset=608, subregisters=[('xmm12', 0, 16)], vector=True), 
        Register(name='ymm13', size=32, vex_offset=640, subregisters=[('xmm13', 0, 16)], vector=True), 
        Register(name='ymm14', size=32, vex_offset=672, subregisters=[('xmm14', 0, 16)], vector=True), 
        Register(name='ymm15', size=32, vex_offset=704, subregisters=[('xmm15', 0, 16)], vector=True), 
        Register(name='ymm16', size=32, vex_offset=736, subregisters=[('xmm16', 0, 16)], vector=True), 
        Register(name='ftop', size=4, vex_offset=768, floating_point=True, default_value=(0, False, None)), 
        Register(name='fpreg', size=64, vex_offset=776, subregisters=[('mm0', 0, 8),
                                                                      ('mm1', 8, 8),
                                                                      ('mm2', 16, 8),
                                                                      ('mm3', 24, 8),
                                                                      ('mm4', 32, 8),
        ...
        Register(name='fptag', size=8, vex_offset=840, alias_names=('fpu_tags',),
                 floating_point=True, default_value=(0, False, None)), 
        Register(name='fpround', size=8, vex_offset=848, floating_point=True, default_value=(0, False, None)), 
        Register(name='fc3210', size=8, vex_offset=856, floating_point=True), 
        Register(name='emnote', size=4, vex_offset=864),
        Register(name='cmstart', size=8, vex_offset=872),
        Register(name='cmlen', size=8, vex_offset=880),
        Register(name='nraddr', size=8, vex_offset=888),
        Register(name='gs', size=8, vex_offset=904, alias_names=('gs_const',), concrete=False),
        Register(name='ip_at_syscall', size=8, vex_offset=912, concrete=False),
        Register(name='eflags', size=8, vex_offset=920)
    ]

...
class ArchX86(Arch):
    ...
    register_list = [
        Register(name='eax', size=4, vex_offset=8, subregisters=[('ax', 0, 2),
                                                                 ('al', 0, 1),
<<<<<<< HEAD
                                                                 ('ah', 1, 1)],
=======
...
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        ...
        Register(name='ecx', size=4, vex_offset=12, subregisters=[('cx', 0, 2),
                                                                  ('cl', 0, 1),
                                                                  ('ch', 1, 1)], 
<<<<<<< HEAD
                 general_purpose=True, argument=True, concrete=True),
=======
                 general_purpose=True, argument=True),
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        Register(name='edx', size=4, vex_offset=16, subregisters=[('dx', 0, 2),
                                                                  ('dl', 0, 1),
                                                                  ('dh', 1, 1)], 
                 general_purpose=True, argument=True, linux_entry_value='ld_destructor'),
        Register(name='ebx', size=4, vex_offset=20, subregisters=[('bx', 0, 2),
                                                                  ('bl', 0, 1),
                                                                  ('bh', 1, 1)], 
<<<<<<< HEAD
                 general_purpose=True, argument=True, concrete=True),
=======
                 general_purpose=True, argument=True),
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        Register(name='esp', size=4, vex_offset=24, alias_names=('sp',), 
                 general_purpose=True, default_value=(Arch.initial_sp, True, 'global')),
        Register(name='ebp', size=4, vex_offset=28, alias_names=('bp',), 
                 general_purpose=True, argument=True, linux_entry_value=0),
        Register(name='esi', size=4, vex_offset=32, subregisters=[('si', 0, 2),
                                                                  ('sil', 0, 1),
                                                                  ('sih', 1, 1)], 
                 general_purpose=True, argument=True),
        Register(name='edi', size=4, vex_offset=36, subregisters=[('di', 0, 2),
                                                                  ('dil', 0, 1),
                                                                  ('dih', 1, 1)], 
                 general_purpose=True, argument=True),
<<<<<<< HEAD
        Register(name='cc_op', size=4, vex_offset=40, default_value=(0, False, None), concrete=False),
        Register(name='cc_dep1', size=4, vex_offset=44, concrete=False),
        Register(name='cc_dep2', size=4, vex_offset=48, concrete=False),
        Register(name='cc_ndep', size=4, vex_offset=52, concrete=False),
        Register(name='d', size=4, vex_offset=56, alias_names=('dflag',),
                 default_value=(1, False, None), concrete=False),
        Register(name='id', size=4, vex_offset=60, alias_names=('idflag',),
                 default_value=(1, False, None), concrete=False),
        Register(name='ac', size=4, vex_offset=64, alias_names=('acflag',),
                 default_value=(0, False, None), concrete=False),
=======
        Register(name='cc_op', size=4, vex_offset=40, default_value=(0, False, None)),
        Register(name='cc_dep1', size=4, vex_offset=44),
        Register(name='cc_dep2', size=4, vex_offset=48),
        Register(name='cc_ndep', size=4, vex_offset=52),
        Register(name='d', size=4, vex_offset=56, alias_names=('dflag',),
...
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        Register(name='eip', size=4, vex_offset=68, alias_names=('ip', 'pc')), 
        Register(name='fpreg', size=64, vex_offset=72, subregisters=[('mm0', 0, 8),
                                                                     ('mm1', 8, 8),
                                                                     ('mm2', 16, 8),
                                                                     ('mm3', 24, 8),
                                                                     ('mm4', 32, 8),
...
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        Register(name='fptag', size=8, vex_offset=136, alias_names=('fpu_tags',),
                 floating_point=True, default_value=(0, False, None)), 
        Register(name='fpround', size=4, vex_offset=144, floating_point=True,
                 default_value=(0, False, None)), 
        Register(name='fc3210', size=4, vex_offset=148, floating_point=True), 
        Register(name='ftop', size=4, vex_offset=152, floating_point=True,
                 default_value=(0, False, None)), 
        Register(name='sseround', size=4, vex_offset=156, vector=True,
                 default_value=(0, False, None)), 
        Register(name='xmm0', size=16, vex_offset=160, vector=True),
        Register(name='xmm1', size=16, vex_offset=176, vector=True),
        Register(name='xmm2', size=16, vex_offset=192, vector=True),
        Register(name='xmm3', size=16, vex_offset=208, vector=True),
        Register(name='xmm4', size=16, vex_offset=224, vector=True),
        Register(name='xmm5', size=16, vex_offset=240, vector=True),
        Register(name='xmm6', size=16, vex_offset=256, vector=True),
        Register(name='xmm7', size=16, vex_offset=272, vector=True),
        Register(name='cs', size=2, vex_offset=288),
        Register(name='ds', size=2, vex_offset=290),
        Register(name='es', size=2, vex_offset=292),
<<<<<<< HEAD
        Register(name='fs', size=2, vex_offset=294, default_value=(0, False, None), concrete=False),
...
=======
        Register(name='fs', size=2, vex_offset=294, default_value=(0, False, None)),
        Register(name='gs', size=2, vex_offset=296, default_value=(0, False, None)),
        Register(name='ss', size=2, vex_offset=298),
        Register(name='ldt', size=8, vex_offset=304, default_value=(0, False, None)),
        Register(name='gdt', size=8, vex_offset=312, default_value=(0, False, None)),
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
        ...
        Register(name='nraddr', size=4, vex_offset=332),
        Register(name='sc_class', size=4, vex_offset=336),
<<<<<<< HEAD
        Register(name='ip_at_syscall', size=4, vex_offset=340, concrete=False),
        Register(name='eflags', size=4, vex_offset=344)
=======
        Register(name='ip_at_syscall', size=4, vex_offset=340),
>>>>>>> c7486134da53318499971b69c1b0204320bb0801
    ]

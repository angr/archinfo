...
class ArchARM(Arch):
    ...
    register_list = [
        Register(name='r0', size=4, vex_offset=8, alias_names=('a1',),
                 general_purpose=True, argument=True, linux_entry_value='ld_destructor'),
        Register(name='r1', size=4, vex_offset=12, alias_names=('a2',),
                 general_purpose=True, argument=True),
        Register(name='r2', size=4, vex_offset=16, alias_names=('a3',),
                 general_purpose=True, argument=True),
        Register(name='r3', size=4, vex_offset=20, alias_names=('a4',),
                 general_purpose=True, argument=True),
        Register(name='r4', size=4, vex_offset=24, alias_names=('v1',),
                 general_purpose=True),
        Register(name='r5', size=4, vex_offset=28, alias_names=('v2',),
                 general_purpose=True),
        Register(name='r6', size=4, vex_offset=32, alias_names=('v3',),
                 general_purpose=True),
        Register(name='r7', size=4, vex_offset=36, alias_names=('v4',),
                 general_purpose=True),
        Register(name='r8', size=4, vex_offset=40, alias_names=('v5',),
                 general_purpose=True),
        Register(name='r9', size=4, vex_offset=44, alias_names=('v6', 'sb'),
                 general_purpose=True),
        Register(name='r10', size=4, vex_offset=48, alias_names=('v7', 'sl'),
                 general_purpose=True),
        Register(name='r11', size=4, vex_offset=52, alias_names=('v8', 'fp', 'bp'),
                 general_purpose=True),
        Register(name='r12', size=4, vex_offset=56, general_purpose=True),
        ...
        Register(name='pc', size=4, vex_offset=68, alias_names=('r15', 'ip')),
